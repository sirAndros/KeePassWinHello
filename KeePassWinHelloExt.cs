...
//                    ComboBox m_cmbKeyFile = GetComboBox(keyPromptForm);
//                    if (m_cmbKeyFile != null)
//                    {
//                        IOConnectionInfo ioInfo = GetIoInfo(keyPromptForm);
//                        if (ioInfo != null)
//                        {
//                            WinHelloKeyProvider.WinHelloData item;
//                            if (_provider._unlockCache.TryGetValue(ioInfo.Path, out item))
//                            {
//                                if (item.IsLastLoginOur && !item.KeyFile.IsEmpty)
//                                {
//                                    m_cmbKeyFile.Items.Add(item.KeyFile.ReadString());
//                                }
//                                if (item.IsValid())
//                                {
...
//                keyPromptForm.FormClosing += delegate (object sender2, FormClosingEventArgs e2)
//                {
//                    IOConnectionInfo ioInfo = GetIoInfo(keyPromptForm);
//                    if (ioInfo != null)
//                    {
...
//                        if (m_cmbKeyFile != null)
//                        {
//                            var oldKey = m_cmbKeyFile.Text;
//                            if (!KeePass.Program.KeyProviderPool.IsKeyProvider(oldKey))
//                            {
//                                WinHelloKeyProvider.WinHelloData item;
//                                if (!_provider._unlockCache.TryGetValue(ioInfo.Path, out item))
//                                    item = new WinHelloKeyProvider.WinHelloData();
//                                item.IsLastLoginOur = false;
//                                item.KeyFile = new ProtectedString(true, oldKey);
//                                _provider._unlockCache[ioInfo.Path] = item;
//                            }
//                        }
//                    }
//                };
...
//        private void AddWinHelloTab(OptionsForm optionsForm)
//        {
...
//        private static ComboBox GetComboBox(KeyPromptForm keyPromptForm)
//        {
//            return keyPromptForm.Controls.Find("m_cmbKeyFile", false).FirstOrDefault() as ComboBox;
//        }
//    }
//}
